  ...
  return (
    <div className="min-h-screen" dir="rtl">
      <div className="container mx-auto py-6 px-4 sm:px-6 lg:px-8 mt-30">
        ...
        <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 mb-8 text-white shadow-lg shadow-blue-500/5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          <div className=" bg-purple-700/30 backdrop-blur-md border border-white/20 rounded-2xl shadow-lg shadow-blue-500/5 p-6 text-white">
            <div className="flex justify-between items-center mb-4">
              ...
              <button className="bg-white/20 backdrop-blur-sm text-white px-3 py-1 rounded-lg text-sm border border-white/10 hover:bg-white/30 transition">
                + شارژ
              </button>
            </div>
          ...
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl shadow-lg shadow-blue-500/5 p-6 lg:col-span-2 text-white">
            <div className="flex items-center justify-center gap-2 mb-4 bg-white/10 backdrop-blur-sm p-3 rounded-xl border border-white/10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
          <div className="bg-blue-500/20 backdrop-blur-md border border-blue-400/30 rounded-2xl p-6 text-white shadow-lg shadow-blue-500/5">
            <div className="flex justify-between items-start">
              <div>
                <div className="flex items-center gap-2 mb-2">
                  <span className="text-2xl">🎫</span>

                  <span className="text-sm text-white/80">درخواست فعال</span>
                </div>
              ...
              <button
                ...
                className="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-lg text-sm border border-white/10 hover:bg-white/30 transition"
              >
                + درخواست جدید
              </button>
            </div>
          ...
          <div className="bg-green-500/20 backdrop-blur-md border border-green-400/30 rounded-2xl p-6 text-white shadow-lg shadow-green-500/5">
            <div className="flex justify-between items-start">
              <div>
                <div className="flex items-center gap-2 mb-2">
                  <span className="text-2xl">✅</span>

                  <span className="text-sm text-white/80">تکمیل/بسته شده</span>
                </div>
        ...
        <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl shadow-lg shadow-blue-500/5 overflow-hidden text-white">
          <div className="px-6 py-4 border-b border-white/10 flex justify-between items-center">
            <div>
              ...
              <p className="text-white/50 text-sm">درخواست‌های اخیر شما</p>
            </div>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full">
                <thead className="bg-white/5">
                  <tr>
                    <th className="px-6 py-3 text-right text-xs text-white/60">
                      شناسه
                    </th>
                ...
                <tbody>
                  {requests.map((req) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-sm font-medium text-blue-300">
      ...
      {showNewRequestModal && (
        ...
        >
          <div
            className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-y-auto text-white"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Header */}

            <div className="sticky top-0 z-10 bg-black backdrop-blur-xl border-b border-white/10 px-6 py-4 flex justify-between items-center">
              <div>
              ...
              <button
                onClick={() => setShowNewRequestModal(false)}
                className="w-9 h-9 rounded-full bg-white/10 hover:bg-white/20 text-white/60 text-2xl transition"
              >
                &times;
              </button>
            </div>
            ...
            <div className="p-6 space-y-5">
              ...
              <div>
                <label className="block text-sm font-bold text-white/90 mb-3">
                  طرح پشتیبانی <span className="text-red-400">*</span>
                </label>
                    ...
                    return (
                      <button
                        ...
                        className={`
                            ...
                            ${
                              isSelected
                                ? "border-blue-400 bg-blue-500/20 shadow-lg shadow-blue-500/20 scale-[1.01]"
                                : "border-white/10 bg-white/5 hover:border-white/30 hover:bg-white/10"
                            }
                          `}
                      >
                        {isSelected && (
                          <div className="absolute top-3 left-3 w-6 h-6 rounded-full bg-blue-500 text-white flex items-center justify-center text-xs font-bold shadow-sm">
                            ✓
                          </div>
                        )}
              ...
              {isDateRequired(newRequest.plan) && (
                <div className="p-4 bg-blue-500/10 backdrop-blur-sm rounded-2xl border border-blue-400/20 space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-white/90 mb-2">
                  شرح درخواست <span className="text-red-400">*</span>
                </label>
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full p-2 border border-white/20 rounded-lg bg-white/10 backdrop-blur-sm text-white placeholder-white/40"
              ...
              <div>
                <label className="block text-sm font-medium text-white/90 mb-2">
                  کد AnyDesk <span className="text-red-400">*</span>
                </label>
            ...
            <div className="bg-white/5 backdrop-blur-sm border-t border-white/10 px-6 py-4 flex justify-end gap-3">
              <button
                onClick={() => setShowNewRequestModal(false)}
                className="px-4 py-2 bg-white/10 hover:bg-white/20 rounded-lg transition text-white/80"
              >
                انصراف
              </button>
              ...
              <button
                ...
                className="px-5 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg disabled:opacity-50 transition"
              >
      ...
      {showAllRequests && (
        ...
        >
          <div
            className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl max-w-6xl w-full max-h-[90vh] overflow-y-auto text-white"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="sticky top-0 bg-white/10 backdrop-blur-xl border-b border-white/10 px-6 py-4 flex justify-between">
              ...
              <button
                onClick={closeModal}
                className="text-white/50 text-2xl hover:text-white/80 transition"
              >
                &times;
              </button>
            </div>
          ...
          >
            ...
            <div className="p-6 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="col-span-2 bg-white/5 backdrop-blur-sm rounded-lg p-3 border border-white/5">
                ...
                {isDateRequired(selectedRequest.plan) && (
                  <div className="col-span-2 bg-blue-500/10 border border-blue-400/20 rounded-lg p-4">
                ...
                <div className="col-span-2">
                  ...
                  <p className="bg-white/5 backdrop-blur-sm p-3 rounded border border-white/5 mt-1 text-white/90">
                    {selectedRequest.description || "—"}
                  </p>
                </div>

                <div className="col-span-2">
                  <label className="text-sm text-white/50">کد AnyDesk</label>

                  <p
                    className="bg-white/5 backdrop-blur-sm p-3 rounded border border-white/5 mt-1 text-white/90"
                    dir="ltr"
                  >
